...
#  sebms_data_swetiff@file@name <- "C:\\Users\\IEUser\\Documents\\GitHub\\swedishbutterflies\\data-raw\\figures\\MapDistribution-data\\R_files_for_similar_map\\MapSweden.tif"